...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      {/* Content-driven mobile hero; full-screen min-height on desktop */}
      <div className="relative flex flex-col justify-between px-4 pt-20 pb-8 sm:px-6 sm:pt-24 sm:pb-10 md:min-h-screen md:px-10 md:pt-28 md:pb-12 lg:pt-32 lg:pb-14">
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col justify-between">
          ...
          <div className="flex flex-col pt-1 sm:pt-2">
            ...
            {/* Headline */}
            <h1 className="mt-4 max-w-6xl text-[clamp(2.15rem,9.2vw,3.6rem)] leading-[0.98] font-medium tracking-[-0.035em] sm:mt-6 md:mt-8 md:text-[clamp(2.5rem,7.5vw,6.5rem)]">
          ...
          {/* Bottom group: Description + Action Buttons + Scroll indicator */}
          <div className="mt-6 flex flex-col gap-4 sm:gap-6 md:mt-12 md:max-w-4xl pb-1 md:pb-3">
            {/* Description - visible across screen sizes for content-driven mobile hierarchy */}
            <p
              className="fade-up text-base leading-relaxed text-pretty text-muted-foreground md:text-lg lg:text-xl"
              style={d(700)}
            >
            ...
            {/* Scroll indicator sitting in natural document flow */}
            <div
              className="fade-up pt-4 sm:pt-6 flex items-center gap-2.5 text-[11px] font-mono tracking-[0.18em] uppercase text-muted-foreground/70"
              style={d(900)}
            >
